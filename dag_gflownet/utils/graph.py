...
def sample_erdos_renyi_graph(
    ...
    # Permute the rows and columns, this is only to relabel the nodes and will not result in any change in the structure of the graph (Search graph isomorphysm)
