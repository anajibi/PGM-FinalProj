...
%            Dataset 3.1-.3   & 2000                    & 200,000               & 1                         \\
    ...
    % figure with 2 subfigures and two lines
    \begin{figure*}[h]
        \centering
        \begin{subfigure}
            \centering
...
%        \begin{subfigure}
%            \centering
%            \includegraphics[width=0.48\textwidth]{figures/BGe_15_30_150}
%            \label{fig:bge_score_15_30_150}
%        \end{subfigure}
%        \begin{subfigure}
%            \centering
%            \includegraphics[width=0.48\textwidth]{figures/BGe_15_30_250}
%            \label{fig:bge_score_15_30_250}
%        \end{subfigure}
%        \hfill
%        \begin{subfigure}
%            \centering
%            \includegraphics[width=0.48\textwidth]{figures/P_d_prime_15_30_150}
%            \label{fig:p_d_15_30_150}
%        \end{subfigure}
%        \begin{subfigure}
%            \centering
%            \includegraphics[width=0.48\textwidth]{figures/P_d_prime_15_30_250}
%            \label{fig:p_d_15_30_250}
%        \end{subfigure}
%        \caption{BGe score distribution and held-out likelihood for Dataset 2.2.1 (Fig.~
%        \ref{fig:bge_score_15_30_150,
%        fig:p_d_15_30_150}) and Dataset 2.2.2 (Fig.~\ref{fig:bge_score_15_30_250, fig:p_d_15_30_250}).}
%        \label{fig:illustration_15_30}
%    \end{figure}
    ...
    \begin{figure*}[h]
        ...
        \begin{subfigure}
            \centering
            \includegraphics[width=0.32\textwidth]{figures/expected_0_5_8}
            \label{fig:eshd_5_8}
        \end{subfigure}
        \begin{subfigure}
            \centering
            \includegraphics[width=0.32\textwidth]{figures/auroc_5_8}
            \label{fig:auroc_5_8}
        \end{subfigure}
        \begin{subfigure}
            \centering
            \includegraphics[width=0.32\textwidth]{figures/auprc_5_8}
            \label{fig:auprc_5_8}
        \end{subfigure}
        \caption{E-SHD, AUROC, and AUPRC results for Dataset 1.1 and Dataset 1.2. Fig.~\ref{fig:eshd_5_8} shows
        the E-SHD result for different experiments (x-axis) and the y-axis represents the E-SHD value. Fig.~\ref{
            fig:auroc_5_8, fig:auprc_5_8} shows the AUROC and AUPRC results for different experiments (x-axis) and the
        y-axis represents the AUROC and AUPRC values respectively.}
